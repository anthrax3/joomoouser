...
/**
 * controller for managing JoomooUser table in DB
 */
class JoomooUserController extends JoomooBaseController
{
	/**
	...
	{
		// print "Hello from JoomooUserController::display()<br />\n";

		$model =& $this->getModel( $this->getModelName() );      // instantiates model class

		$view  =& $this->getView( 'JoomooUser', 'html' );        // 'html': use view.html.php (not view.php)
